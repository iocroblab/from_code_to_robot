function q = GetJointSpeeds(order, timeout)
% GetJointStates Return joint velocitys as [6x1] in a specified joint order.
%
...
% - Reorders velocitys to match `order`, independent of /joint_states.name order.
