...
class TrajectoryPublisher(Node):
    def __init__(self):
        ...
        self.tracked_frame = (
            self.get_parameter('tracked_frame').get_parameter_value().string_value
        )
        self.world_frame = (
    ...
    def create_pointcloud2(self, points):
        """
        Create a PointCloud2 message from an Nx3 list of points.
        ...
        # Pack data
        data = bytearray()
        yellow_rgb = struct.unpack('I', struct.pack('BBBB', 0, 255, 255, 0))[0]
        for p in points:
