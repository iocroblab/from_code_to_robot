...
{
  new (message_memory) ros_gz_interfaces::msg::Entity(_init);
}

void Entity_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros_gz_interfaces::msg::Entity *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Entity_message_member_array[3] = {
  {
    ...
    offsetof(ros_gz_interfaces::msg::Entity, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros_gz_interfaces::msg::Entity, name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros_gz_interfaces::msg::Entity, type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Entity_message_members = {
  ...
  "Entity",  // message name
  3,  // number of fields
  sizeof(ros_gz_interfaces::msg::Entity),
...
{
  return &::ros_gz_interfaces::msg::rosidl_typesupport_introspection_cpp::Entity_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_gz_interfaces, msg, Entity)() {
  return &::ros_gz_interfaces::msg::rosidl_typesupport_introspection_cpp::Entity_message_type_support_handle;
}
