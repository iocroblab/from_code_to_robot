...
static const _DeleteEntity_Event_type_support_symbol_names_t _DeleteEntity_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_gz_interfaces, srv, DeleteEntity_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_gz_interfaces, srv, DeleteEntity_Event)),
  }
};
...
{
  return &::ros_gz_interfaces::srv::rosidl_typesupport_cpp::DeleteEntity_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros_gz_interfaces, srv, DeleteEntity_Event)() {
  return get_message_type_support_handle<ros_gz_interfaces::srv::DeleteEntity_Event>();
}
...
static const rosidl_service_type_support_t DeleteEntity_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ros_gz_interfaces::srv::DeleteEntity_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ros_gz_interfaces::srv::DeleteEntity_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ros_gz_interfaces::srv::DeleteEntity_Event>(),
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, ros_gz_interfaces, srv, DeleteEntity)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<ros_gz_interfaces::srv::DeleteEntity>();
}
