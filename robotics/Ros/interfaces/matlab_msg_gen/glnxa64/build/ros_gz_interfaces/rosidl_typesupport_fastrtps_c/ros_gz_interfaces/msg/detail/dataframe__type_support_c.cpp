...
#include "ros_gz_interfaces/msg/detail/dataframe__rosidl_typesupport_fastrtps_c.h"
...
using _Dataframe__ros_msg_type = ros_gz_interfaces__msg__Dataframe;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_gz_interfaces
bool cdr_serialize_ros_gz_interfaces__msg__Dataframe(
  const ros_gz_interfaces__msg__Dataframe * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_gz_interfaces
bool cdr_deserialize_ros_gz_interfaces__msg__Dataframe(
  eprosima::fastcdr::Cdr & cdr,
  ros_gz_interfaces__msg__Dataframe * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_gz_interfaces
size_t get_serialized_size_ros_gz_interfaces__msg__Dataframe(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_gz_interfaces
size_t max_serialized_size_ros_gz_interfaces__msg__Dataframe(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_gz_interfaces__msg__Dataframe;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_gz_interfaces
bool cdr_serialize_key_ros_gz_interfaces__msg__Dataframe(
  const ros_gz_interfaces__msg__Dataframe * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_gz_interfaces
size_t get_serialized_size_key_ros_gz_interfaces__msg__Dataframe(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Dataframe__ros_msg_type * ros_message = static_cast<const _Dataframe__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_gz_interfaces
size_t max_serialized_size_key_ros_gz_interfaces__msg__Dataframe(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros_gz_interfaces__msg__Dataframe * ros_message = static_cast<const ros_gz_interfaces__msg__Dataframe *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros_gz_interfaces__msg__Dataframe(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros_gz_interfaces__msg__Dataframe * ros_message = static_cast<ros_gz_interfaces__msg__Dataframe *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros_gz_interfaces__msg__Dataframe(cdr, ros_message);
}

static uint32_t _Dataframe__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_gz_interfaces__msg__Dataframe(
...
static size_t _Dataframe__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_gz_interfaces__msg__Dataframe(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_gz_interfaces, msg, Dataframe)() {
