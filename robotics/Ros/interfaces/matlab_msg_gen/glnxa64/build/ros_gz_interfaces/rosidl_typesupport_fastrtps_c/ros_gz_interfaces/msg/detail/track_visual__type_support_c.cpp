...
#include "ros_gz_interfaces/msg/detail/track_visual__rosidl_typesupport_fastrtps_c.h"
...
using _TrackVisual__ros_msg_type = ros_gz_interfaces__msg__TrackVisual;
  ...
  ros_gz_interfaces__msg__TrackVisual * ros_message)
{
  ...
  // Field name: xyz
  {
    cdr_deserialize_geometry_msgs__msg__Vector3(cdr, &ros_message->xyz);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_gz_interfaces__msg__TrackVisual;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros_gz_interfaces__msg__TrackVisual * ros_message = static_cast<const ros_gz_interfaces__msg__TrackVisual *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros_gz_interfaces__msg__TrackVisual(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros_gz_interfaces__msg__TrackVisual * ros_message = static_cast<ros_gz_interfaces__msg__TrackVisual *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros_gz_interfaces__msg__TrackVisual(cdr, ros_message);
}

static uint32_t _TrackVisual__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_gz_interfaces__msg__TrackVisual(
...
static size_t _TrackVisual__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_gz_interfaces__msg__TrackVisual(
