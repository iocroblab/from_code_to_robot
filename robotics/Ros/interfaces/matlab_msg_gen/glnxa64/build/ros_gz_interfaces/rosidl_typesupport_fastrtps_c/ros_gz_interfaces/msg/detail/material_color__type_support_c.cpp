...
#include "ros_gz_interfaces/msg/detail/material_color__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/color_rgba__functions.h"  // ambient, diffuse, emissive, specular
...
using _MaterialColor__ros_msg_type = ros_gz_interfaces__msg__MaterialColor;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_gz_interfaces
bool cdr_serialize_ros_gz_interfaces__msg__MaterialColor(
  const ros_gz_interfaces__msg__MaterialColor * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_gz_interfaces
bool cdr_deserialize_ros_gz_interfaces__msg__MaterialColor(
  eprosima::fastcdr::Cdr & cdr,
  ros_gz_interfaces__msg__MaterialColor * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: ambient
  {
    cdr_deserialize_std_msgs__msg__ColorRGBA(cdr, &ros_message->ambient);
  }
  ...
  // Field name: emissive
  {
    cdr_deserialize_std_msgs__msg__ColorRGBA(cdr, &ros_message->emissive);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_gz_interfaces
size_t get_serialized_size_ros_gz_interfaces__msg__MaterialColor(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MaterialColor__ros_msg_type * ros_message = static_cast<const _MaterialColor__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_gz_interfaces
size_t max_serialized_size_ros_gz_interfaces__msg__MaterialColor(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_gz_interfaces__msg__MaterialColor;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_gz_interfaces
bool cdr_serialize_key_ros_gz_interfaces__msg__MaterialColor(
  const ros_gz_interfaces__msg__MaterialColor * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_gz_interfaces
size_t get_serialized_size_key_ros_gz_interfaces__msg__MaterialColor(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MaterialColor__ros_msg_type * ros_message = static_cast<const _MaterialColor__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_gz_interfaces
size_t max_serialized_size_key_ros_gz_interfaces__msg__MaterialColor(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros_gz_interfaces__msg__MaterialColor * ros_message = static_cast<const ros_gz_interfaces__msg__MaterialColor *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros_gz_interfaces__msg__MaterialColor(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros_gz_interfaces__msg__MaterialColor * ros_message = static_cast<ros_gz_interfaces__msg__MaterialColor *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros_gz_interfaces__msg__MaterialColor(cdr, ros_message);
}

static uint32_t _MaterialColor__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_gz_interfaces__msg__MaterialColor(
...
static size_t _MaterialColor__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_gz_interfaces__msg__MaterialColor(
...
static message_type_support_callbacks_t __callbacks_MaterialColor = {
...
static rosidl_message_type_support_t _MaterialColor__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MaterialColor,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_gz_interfaces, msg, MaterialColor)() {
  return &_MaterialColor__type_support;
}
