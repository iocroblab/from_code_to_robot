...
#include "ros_gz_interfaces/msg/detail/entity_factory__rosidl_typesupport_fastrtps_c.h"
...
using _EntityFactory__ros_msg_type = ros_gz_interfaces__msg__EntityFactory;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_gz_interfaces__msg__EntityFactory;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros_gz_interfaces__msg__EntityFactory * ros_message = static_cast<const ros_gz_interfaces__msg__EntityFactory *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros_gz_interfaces__msg__EntityFactory(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros_gz_interfaces__msg__EntityFactory * ros_message = static_cast<ros_gz_interfaces__msg__EntityFactory *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros_gz_interfaces__msg__EntityFactory(cdr, ros_message);
}

static uint32_t _EntityFactory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_gz_interfaces__msg__EntityFactory(
...
static size_t _EntityFactory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_gz_interfaces__msg__EntityFactory(
