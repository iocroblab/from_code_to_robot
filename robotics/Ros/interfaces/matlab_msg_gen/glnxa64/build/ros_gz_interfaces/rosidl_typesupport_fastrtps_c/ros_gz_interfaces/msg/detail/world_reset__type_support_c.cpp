  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros_gz_interfaces__msg__WorldReset * ros_message = static_cast<const ros_gz_interfaces__msg__WorldReset *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros_gz_interfaces__msg__WorldReset(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros_gz_interfaces__msg__WorldReset * ros_message = static_cast<ros_gz_interfaces__msg__WorldReset *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros_gz_interfaces__msg__WorldReset(cdr, ros_message);
}
