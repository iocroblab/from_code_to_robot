...
#include "ros_gz_interfaces/msg/detail/entity__rosidl_typesupport_fastrtps_c.h"
...
using _Entity__ros_msg_type = ros_gz_interfaces__msg__Entity;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_gz_interfaces__msg__Entity;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros_gz_interfaces__msg__Entity * ros_message = static_cast<const ros_gz_interfaces__msg__Entity *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros_gz_interfaces__msg__Entity(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros_gz_interfaces__msg__Entity * ros_message = static_cast<ros_gz_interfaces__msg__Entity *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros_gz_interfaces__msg__Entity(cdr, ros_message);
}

static uint32_t _Entity__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_gz_interfaces__msg__Entity(
...
static size_t _Entity__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_gz_interfaces__msg__Entity(
