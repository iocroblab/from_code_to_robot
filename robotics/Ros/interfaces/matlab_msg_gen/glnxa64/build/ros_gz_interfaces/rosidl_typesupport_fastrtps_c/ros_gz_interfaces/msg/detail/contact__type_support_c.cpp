  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: wrenches
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_ros_gz_interfaces__msg__JointWrench(
        &array_ptr[i], cdr);
    }
  }
  ...
  ros_gz_interfaces__msg__Contact * ros_message)
{
  // Field name: collision1
  {
    cdr_deserialize_ros_gz_interfaces__msg__Entity(cdr, &ros_message->collision1);
  }

  // Field name: collision2
  {
    cdr_deserialize_ros_gz_interfaces__msg__Entity(cdr, &ros_message->collision2);
  }
  ...
  // Field name: wrenches
  {
    ...
    auto array_ptr = ros_message->wrenches.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_ros_gz_interfaces__msg__JointWrench(cdr, &array_ptr[i]);
    }
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: wrenches
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_ros_gz_interfaces__msg__JointWrench(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: wrenches
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_ros_gz_interfaces__msg__JointWrench(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: wrenches
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ros_gz_interfaces__msg__JointWrench(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros_gz_interfaces__msg__Contact * ros_message = static_cast<const ros_gz_interfaces__msg__Contact *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros_gz_interfaces__msg__Contact(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros_gz_interfaces__msg__Contact * ros_message = static_cast<ros_gz_interfaces__msg__Contact *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros_gz_interfaces__msg__Contact(cdr, ros_message);
}
