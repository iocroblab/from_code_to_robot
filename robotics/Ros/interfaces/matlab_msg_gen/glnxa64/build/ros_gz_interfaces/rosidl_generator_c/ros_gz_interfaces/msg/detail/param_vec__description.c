  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xe1, 0x78, 0xb0, 0x8d, 0x6f, 0x16, 0x98, 0xeb,
      0x62, 0x31, 0xc6, 0x8e, 0x41, 0xf5, 0x10, 0xde,
      0x8d, 0xe5, 0x25, 0xd8, 0x42, 0xd0, 0x8d, 0xdc,
      0x7e, 0x20, 0x22, 0xbb, 0x8b, 0x7d, 0x40, 0x49,
    }};
  return &hash;
}
...
static char ros_gz_interfaces__msg__ParamVec__TYPE_NAME[] = "ros_gz_interfaces/msg/ParamVec";
...
static char ros_gz_interfaces__msg__ParamVec__FIELD_NAME__header[] = "header";
static char ros_gz_interfaces__msg__ParamVec__FIELD_NAME__params[] = "params";

static rosidl_runtime_c__type_description__Field ros_gz_interfaces__msg__ParamVec__FIELDS[] = {
  {
    {ros_gz_interfaces__msg__ParamVec__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {ros_gz_interfaces__msg__ParamVec__FIELD_NAME__params, 6, 6},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription ros_gz_interfaces__msg__ParamVec__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {ros_gz_interfaces__msg__ParamVec__TYPE_NAME, 30, 30},
      {ros_gz_interfaces__msg__ParamVec__FIELDS, 2, 2},
    },
    {ros_gz_interfaces__msg__ParamVec__REFERENCED_TYPE_DESCRIPTIONS, 4, 4},
  };
  if (!constructed) {
...
ros_gz_interfaces__msg__ParamVec__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *ros_gz_interfaces__msg__ParamVec__get_individual_type_description_source(NULL),
