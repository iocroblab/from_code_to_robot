...
#include "ros_gz_interfaces/msg/detail/world_reset__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros_gz_interfaces::msg::WorldReset & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_gz_interfaces::msg::WorldReset & ros_message)
{
  // Member: all
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_gz_interfaces::msg::WorldReset;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros_gz_interfaces
max_serialized_size_key_WorldReset(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const ros_gz_interfaces::msg::WorldReset *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_gz_interfaces::msg::WorldReset *>(
    untyped_ros_message);
...
{
  return &ros_gz_interfaces::msg::typesupport_fastrtps_cpp::_WorldReset__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_gz_interfaces, msg, WorldReset)() {
  return &ros_gz_interfaces::msg::typesupport_fastrtps_cpp::_WorldReset__handle;
}
