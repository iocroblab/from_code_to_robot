...
class Init_SetEntityPose_Event_response
{
public:
  explicit Init_SetEntityPose_Event_response(::ros_gz_interfaces::srv::SetEntityPose_Event & msg)
  : msg_(msg)
  {}
  ::ros_gz_interfaces::srv::SetEntityPose_Event response(::ros_gz_interfaces::srv::SetEntityPose_Event::_response_type arg)
  {
...
private:
  ::ros_gz_interfaces::srv::SetEntityPose_Event msg_;
};

class Init_SetEntityPose_Event_request
{
public:
  explicit Init_SetEntityPose_Event_request(::ros_gz_interfaces::srv::SetEntityPose_Event & msg)
  : msg_(msg)
  {}
  Init_SetEntityPose_Event_response request(::ros_gz_interfaces::srv::SetEntityPose_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SetEntityPose_Event_response(msg_);
  }
...
class Init_SetEntityPose_Event_info
{
public:
  Init_SetEntityPose_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetEntityPose_Event_request info(::ros_gz_interfaces::srv::SetEntityPose_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SetEntityPose_Event_request(msg_);
  }
...
template<>
inline
auto build<::ros_gz_interfaces::srv::SetEntityPose_Event>()
{
  return ros_gz_interfaces::srv::builder::Init_SetEntityPose_Event_info();
}
