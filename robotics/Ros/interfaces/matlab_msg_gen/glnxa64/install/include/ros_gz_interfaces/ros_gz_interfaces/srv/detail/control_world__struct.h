...
enum
{
  ros_gz_interfaces__srv__ControlWorld_Event__request__MAX_SIZE = 1
};
// response
enum
{
  ros_gz_interfaces__srv__ControlWorld_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/ControlWorld in the package ros_gz_interfaces.
typedef struct ros_gz_interfaces__srv__ControlWorld_Event
{
  service_msgs__msg__ServiceEventInfo info;
  ros_gz_interfaces__srv__ControlWorld_Request__Sequence request;
  ros_gz_interfaces__srv__ControlWorld_Response__Sequence response;
} ros_gz_interfaces__srv__ControlWorld_Event;

// Struct for a sequence of ros_gz_interfaces__srv__ControlWorld_Event.
typedef struct ros_gz_interfaces__srv__ControlWorld_Event__Sequence
{
