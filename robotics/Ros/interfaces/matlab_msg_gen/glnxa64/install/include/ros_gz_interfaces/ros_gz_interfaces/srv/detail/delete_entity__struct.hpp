...
#ifndef _WIN32
# define DEPRECATED__ros_gz_interfaces__srv__DeleteEntity_Event __attribute__((deprecated))
#else
# define DEPRECATED__ros_gz_interfaces__srv__DeleteEntity_Event __declspec(deprecated)
#endif
...
struct DeleteEntity_Event_
{
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<ros_gz_interfaces::srv::DeleteEntity_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<ros_gz_interfaces::srv::DeleteEntity_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<ros_gz_interfaces::srv::DeleteEntity_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<ros_gz_interfaces::srv::DeleteEntity_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<ros_gz_interfaces::srv::DeleteEntity_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<ros_gz_interfaces::srv::DeleteEntity_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<ros_gz_interfaces::srv::DeleteEntity_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<ros_gz_interfaces::srv::DeleteEntity_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    ros_gz_interfaces::srv::DeleteEntity_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const ros_gz_interfaces::srv::DeleteEntity_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<ros_gz_interfaces::srv::DeleteEntity_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<ros_gz_interfaces::srv::DeleteEntity_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      ros_gz_interfaces::srv::DeleteEntity_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<ros_gz_interfaces::srv::DeleteEntity_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      ros_gz_interfaces::srv::DeleteEntity_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<ros_gz_interfaces::srv::DeleteEntity_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<ros_gz_interfaces::srv::DeleteEntity_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<ros_gz_interfaces::srv::DeleteEntity_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__ros_gz_interfaces__srv__DeleteEntity_Event
    std::shared_ptr<ros_gz_interfaces::srv::DeleteEntity_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__ros_gz_interfaces__srv__DeleteEntity_Event
    std::shared_ptr<ros_gz_interfaces::srv::DeleteEntity_Event_<ContainerAllocator> const>
...
using DeleteEntity_Event =
  ros_gz_interfaces::srv::DeleteEntity_Event_<std::allocator<void>>;
...
struct DeleteEntity
{
  ...
  using Event = ros_gz_interfaces::srv::DeleteEntity_Event;
};
