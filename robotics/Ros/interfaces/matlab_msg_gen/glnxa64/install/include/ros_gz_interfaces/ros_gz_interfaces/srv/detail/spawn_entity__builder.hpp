...
{
public:
  explicit Init_SpawnEntity_Event_response(::ros_gz_interfaces::srv::SpawnEntity_Event & msg)
  : msg_(msg)
  {}
  ::ros_gz_interfaces::srv::SpawnEntity_Event response(::ros_gz_interfaces::srv::SpawnEntity_Event::_response_type arg)
  {
...
private:
  ::ros_gz_interfaces::srv::SpawnEntity_Event msg_;
};

class Init_SpawnEntity_Event_request
{
public:
  explicit Init_SpawnEntity_Event_request(::ros_gz_interfaces::srv::SpawnEntity_Event & msg)
  : msg_(msg)
  {}
  Init_SpawnEntity_Event_response request(::ros_gz_interfaces::srv::SpawnEntity_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SpawnEntity_Event_request info(::ros_gz_interfaces::srv::SpawnEntity_Event::_info_type arg)
  {
...
template<>
inline
auto build<::ros_gz_interfaces::srv::SpawnEntity_Event>()
{
  return ros_gz_interfaces::srv::builder::Init_SpawnEntity_Event_info();
}
