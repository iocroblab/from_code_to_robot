...
[[deprecated("use ros_gz_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const ros_gz_interfaces::srv::SpawnEntity_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  ros_gz_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use ros_gz_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const ros_gz_interfaces::srv::SpawnEntity_Event & msg)
{
  return ros_gz_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<ros_gz_interfaces::srv::SpawnEntity_Event>()
{
  return "ros_gz_interfaces::srv::SpawnEntity_Event";
}

template<>
inline const char * name<ros_gz_interfaces::srv::SpawnEntity_Event>()
{
  return "ros_gz_interfaces/srv/SpawnEntity_Event";
}

template<>
struct has_fixed_size<ros_gz_interfaces::srv::SpawnEntity_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<ros_gz_interfaces::srv::SpawnEntity_Event>
  : std::integral_constant<bool, has_bounded_size<ros_gz_interfaces::srv::SpawnEntity_Request>::value && has_bounded_size<ros_gz_interfaces::srv::SpawnEntity_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<ros_gz_interfaces::srv::SpawnEntity_Event>
  : std::true_type {};
