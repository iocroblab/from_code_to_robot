...
{
  new (message_memory) ros_gz_interfaces::msg::Dataframe(_init);
}

void Dataframe_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros_gz_interfaces::msg::Dataframe *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Dataframe_message_member_array[5] = {
  {
    ...
    offsetof(ros_gz_interfaces::msg::Dataframe, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros_gz_interfaces::msg::Dataframe, src_address),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros_gz_interfaces::msg::Dataframe, dst_address),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros_gz_interfaces::msg::Dataframe, data),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros_gz_interfaces::msg::Dataframe, rssi),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Dataframe_message_members = {
  ...
  5,  // number of fields
  sizeof(ros_gz_interfaces::msg::Dataframe),
...
get_message_type_support_handle<ros_gz_interfaces::msg::Dataframe>()
{
  return &::ros_gz_interfaces::msg::rosidl_typesupport_introspection_cpp::Dataframe_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_gz_interfaces, msg, Dataframe)() {
  return &::ros_gz_interfaces::msg::rosidl_typesupport_introspection_cpp::Dataframe_message_type_support_handle;
}
