...
#ifndef ROS_GZ_INTERFACES__SRV__DETAIL__SET_ENTITY_POSE__FUNCTIONS_H_
#define ROS_GZ_INTERFACES__SRV__DETAIL__SET_ENTITY_POSE__FUNCTIONS_H_
...
/// Initialize srv/SetEntityPose message.
/**
...
/// Finalize srv/SetEntityPose message.
/**
...
/// Create srv/SetEntityPose message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ros_gz_interfaces__srv__SetEntityPose_Request__init().
...
/// Destroy srv/SetEntityPose message.
/**
 * It calls
 * ros_gz_interfaces__srv__SetEntityPose_Request__fini()
...
/// Check for srv/SetEntityPose message equality.
/**
...
/// Copy a srv/SetEntityPose message.
/**
...
/// Initialize array of srv/SetEntityPose messages.
/**
...
/// Finalize array of srv/SetEntityPose messages.
/**
 * It calls
 * ros_gz_interfaces__srv__SetEntityPose_Request__fini()
...
/// Create array of srv/SetEntityPose messages.
/**
...
/// Destroy array of srv/SetEntityPose messages.
/**
 * It calls
 * ros_gz_interfaces__srv__SetEntityPose_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetEntityPose message array equality.
/**
...
/// Copy an array of srv/SetEntityPose messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ros_gz_interfaces__srv__SetEntityPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros_gz_interfaces
...
/**
 * It calls
 * ros_gz_interfaces__srv__SetEntityPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ros_gz_interfaces
...
/**
 * It calls
 * ros_gz_interfaces__srv__SetEntityPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * ros_gz_interfaces__srv__SetEntityPose_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_ros_gz_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ros_gz_interfaces__srv__SetEntityPose_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros_gz_interfaces
...
/**
 * It calls
 * ros_gz_interfaces__srv__SetEntityPose_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ros_gz_interfaces
...
/**
 * It allocates the memory for the array and calls
 * ros_gz_interfaces__srv__SetEntityPose_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros_gz_interfaces
...
/**
 * It calls
 * ros_gz_interfaces__srv__SetEntityPose_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROS_GZ_INTERFACES__SRV__DETAIL__SET_ENTITY_POSE__FUNCTIONS_H_
