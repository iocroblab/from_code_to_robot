...
%
% trainedDetector = trainYOLOv8ObjectDetector(confiagFile, baseModel) trains a
...
arguments
    ...
    options.MiniBatchSize (1,1) {mustBeNumeric, mustBePositive, mustBeReal, mustBeFinite} = 1;
