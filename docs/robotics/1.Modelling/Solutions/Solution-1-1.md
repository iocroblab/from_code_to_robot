...
Find the homogeneous transforms between two consecutive frames
...
```matlab
T12 = transl([0,0,-0.2])*trotz(pi/2);  
T23 = transl([0,0,-0.15])*trotz(-pi/2); 
T34 = transl([0,0.2,0]);  
```
...
Find the homogeneous transform between frame 1 and frame 4. Additionally extract the origin of frame 4 w.r.t. frame 1. 
...
Find the homogeneous transform from frame 4 to frame 1. Additionally give the origin of frame 1 w.r.t. frame 4. 
...
```matlabTextOutput
Checking exercise 1-1-3: Check Transform and position of origin

Checking variables:
 
Checking Variable T41
[OK] T41 is of type double
[OK] T41 correct

Checking Variable origin41
[OK] origin41 is of type double
[OK] origin41 correct
```
# Task 4
...
```matlabTextOutput
Checking exercise 1-1-4: Checking Camera Calibration

Checking variables:
 
Checking Variable TWCam
[OK] TWCam is of type double
[OK] TWCam correct

Checking Variable TWO
[OK] TWO is of type double
[OK] TWO correct
```
