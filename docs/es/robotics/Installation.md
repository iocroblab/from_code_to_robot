...
**Due to specific names of the docker image and workspaces, its recommended to follow the steps below.**
...
###  `7. Setup Workspace` 
 ...
 `execute the following commands in the docker terminal inside WSL:` 
...
Result: Close all ROS applications
