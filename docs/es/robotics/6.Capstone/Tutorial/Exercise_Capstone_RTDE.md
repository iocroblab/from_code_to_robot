...
## Table of Contents
&emsp;[Computer Vision](#TMP_4aff)
 
&emsp;&emsp;[Fruit Detection Function](#TMP_5040)
 
&emsp;&emsp;[Video output](#TMP_9e50)
 
&emsp;&emsp;[Testing](#TMP_44e4)
 
&emsp;[Robotics](#TMP_0239)
 
&emsp;&emsp;[Interprete fruit motion](#TMP_201c)
 
&emsp;&emsp;&emsp;[Base Fruit](#TMP_2e6e)
 
&emsp;&emsp;&emsp;[TCP Fruit](#TMP_64d7)
 
&emsp;&emsp;[Velocity Scaling](#TMP_0360)
 
&emsp;&emsp;&emsp;[Basic Control gains](#TMP_18f0)
 
&emsp;&emsp;&emsp;[Dynamic velocity scaling](#TMP_46b5)
 
&emsp;&emsp;&emsp;[Derivation of the velocity regions](#TMP_0b27)
 
&emsp;&emsp;[Joint Velocity Computation](#TMP_567d)
 
&emsp;&emsp;[Cartesian Velocity Saturation](#TMP_3fbc)
 
&emsp;&emsp;[Damped Jacobian Pseudoinverse](#TMP_642b)
 
&emsp;&emsp;&emsp;[Compute Joint Velocities](#TMP_8efa)
 
&emsp;&emsp;&emsp;[Scale/saturate the Joint Velocities](#TMP_3c1a)
 
&emsp;&emsp;&emsp;[Apply joint velocities to the real robot](#TMP_4a6a)
 
&emsp;&emsp;[Control Loop](#TMP_0a86)
 
&emsp;[Implementation](#TMP_2cc8)
 
&emsp;&emsp;[Robotics Setup](#TMP_7d98)
 
&emsp;&emsp;[Visualize the Regions](#TMP_5dc7)
...
![image_0.png](Exercise_Capstone_RTDE_media/image_0.png)
...
use the function sendSpeedJCommands(ur\_rtde , q\_dot) to send the joint velocities to the robot. 
...
-  q = readJointConfiguration(ur\_rtde); 
...
-  JointStatesToRviz(q, ur\_model, \[ \], 'Ellipsoid', true, 'EllipsoidResolution', 15); 
