...
This package explains the relations between joint angles and resulting pose of end\-effectors. Using this knowledge you will compute required joint angles for a desired pose and trajectories to move the joints in a controlled manner. 
...
### [Exercise 2.3 \- Inverse Kinematic Anthropomorphic arm with Spherical Wrist](./2.Kinematics/Exercises/Exercise-2-3.md)

In this exercise you will compute the analytical inverse kinematic solutions for an Anthropomorphic arm with Spherical Wrist using the techniques explained in the tutorial. 
...
This package explains the relation between joint velocities and cartesian velocities of the end\-effector. Building on this knowledge you will learn how to setup a numerical inverse kinematic algorithm and learn about the manipulability of robots and what challenges occur. 
...
This tutorial explains if and with how much effort a robot can move in specific configurations. It will explain the concept of singularities and redundancy and showcase some examples in Rviz. 
...
In this exercise you will setup the pseudo inverse kinematic algorithm and analyze the convergence and error it produces. You will use quaternions to compute the orientation error using the analytical jacobian. 

### [Exercise 3.3 \- Velocity Teleoperation](<./3.Differential Kinematics/Exercise/Exercise-3-3.md>)

In this exercise you will simulate a robot and control the end\-effector with your keyboard by computing the required joint speeds. 

# 4. Dynamics

This package explains the relation between joint states, \- speeds and \- torques using the lagrange formulation. You will also learn how to estimate parameters of your robot given sufficient testing data, this allows you to approximate e.g. the weight or inertia matrices of your robot manipulator. 
...
This package explains different approaches to robotic control algorithms. E.g. centralized and decentralized control schemes, feedforward control and how Simulink can be utilized for robot control. 
